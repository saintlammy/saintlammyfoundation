            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className="space-y-3 mb-6">
                  ...
                  {beneficiary.schoolGrade && (
                    <div className="flex items-center text-gray-600 dark:text-gray-300">
                      <GraduationCap className="w-5 h-5 mr-3 text-gray-500 dark:text-gray-400" />
              ...
              <div>
                <div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 mb-6">
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 font-display">
                  ...
                  <div className="space-y-4">
                    ...
                    <label className="flex items-center p-4 bg-gray-100 dark:bg-gray-800/30 rounded-lg cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800/50 transition-colors">
                      <input
                        ...
                        className="sr-only"
                      />
                      <div className={`w-4 h-4 rounded-full border-2 mr-4 ${sponsorshipType === 'monthly' ? 'border-accent-500 bg-accent-500' : 'border-gray-400 dark:border-gray-400'}`}></div>
                      <div className="flex-grow">
                        <div className="flex items-center justify-between">
                          <h5 className="font-semibold text-gray-900 dark:text-white">Monthly Sponsorship</h5>
                    ...
                    <label className="flex items-center p-4 bg-gray-100 dark:bg-gray-800/30 rounded-lg cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800/50 transition-colors">
                      <input
                        ...
                        className="sr-only"
                      />
                      <div className={`w-4 h-4 rounded-full border-2 mr-4 ${sponsorshipType === 'one-time' ? 'border-accent-500 bg-accent-500' : 'border-gray-400 dark:border-gray-400'}`}></div>
                      <div className="flex-grow">
                        <div className="flex items-center justify-between">
                          <h5 className="font-semibold text-gray-900 dark:text-white">6-Month Support</h5>
                    ...
                    <label className="flex items-center p-4 bg-gray-100 dark:bg-gray-800/30 rounded-lg cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800/50 transition-colors">
                      <input
                        ...
                        className="sr-only"
                      />
                      <div className={`w-4 h-4 rounded-full border-2 mr-4 ${sponsorshipType === 'custom' ? 'border-accent-500 bg-accent-500' : 'border-gray-400 dark:border-gray-400'}`}></div>
                      <div className="flex-grow">
                        <div className="flex items-center justify-between">
                          <h5 className="font-semibold text-gray-900 dark:text-white">Custom Amount</h5>
              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 mb-8">
                <div className="space-y-3 text-left">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900 dark:text-white font-medium">{beneficiary.name}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Sponsorship Type:</span>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900 dark:text-white font-medium">{sponsorInfo.name}</span>
                  </div>
                </div>
              </div>
