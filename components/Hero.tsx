      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        <div className="animate-slide-up">
          ...
          <div className="flex justify-center mb-6 sm:mb-8">
            ...
            <div className="sm:hidden inline-flex items-center px-3 py-2 rounded-full bg-gray-900/20 dark:bg-white/10 backdrop-blur-md border border-gray-900/30 dark:border-white/20 text-xs font-medium text-gray-900 dark:text-white shadow-sm">
              <span className="w-2 h-2 bg-accent-400 rounded-full mr-2 animate-pulse flex-shrink-0"></span>
              <span>CAC Registered</span>
            </div>
            {/* Desktop version - full text */}
            <div className="hidden sm:inline-flex items-center px-4 py-2 rounded-full bg-gray-900/20 dark:bg-white/10 backdrop-blur-md border border-gray-900/30 dark:border-white/20 text-sm font-medium text-gray-900 dark:text-white shadow-sm">
              <span className="w-2 h-2 bg-accent-400 rounded-full mr-3 animate-pulse flex-shrink-0"></span>
              <span>CAC Registered: Saintlammy Community Care Initiative</span>
            </div>
          </div>
