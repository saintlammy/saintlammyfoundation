      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4">
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-4 right-4 z-10 p-2 rounded-full bg-white/90 backdrop-blur-sm hover:bg-gray-100 transition-colors duration-200 shadow-lg"
            ...
            <div className="overflow-y-auto max-h-[90vh]">
              {/* Header with Image */}
              <div className="relative h-64 bg-gradient-to-br from-amber-50 via-teal-50 to-amber-50">
                {profile.image_url ? (
                  <img
                  ...
                  <div className="w-full h-full flex items-center justify-center">
                    <div className="w-32 h-32 rounded-full bg-white/80 flex items-center justify-center shadow-xl">
                ...
                {/* Profile Code Badge */}
                <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-bold text-gray-800 shadow-md">
              ...
              <div className="p-8">
                ...
                {profile.how_your_gift_helps && (
                  <div className="mb-6 p-5 bg-gradient-to-br from-amber-50 to-amber-100/50 rounded-xl border border-amber-200">
                ...
                {profile.funding_goal && profile.funding_goal > 0 && (
                  <div className="mb-6 p-5 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                      <div
                        className="bg-gradient-to-r from-amber-500 via-amber-600 to-teal-600 h-3 rounded-full transition-all duration-500"
                        style={{
                          width: `${Math.min(
                ...
                {/* CTA Button */}
                <div className="sticky bottom-0 pt-6 pb-2 bg-white -mx-8 px-8 border-t border-gray-200">
                  <button
                    onClick={handleSponsorClick}
                    className="w-full py-4 px-6 bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-700 hover:to-amber-600 text-white rounded-xl transition-all duration-200 text-lg font-bold shadow-lg hover:shadow-xl flex items-center justify-center gap-3"
                  >
