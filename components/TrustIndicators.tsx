  ...
  return (
    <section className="py-24 bg-gray-900">
      <div className="max-w-7xl mx-auto px-6">
          ...
          {[
            {
              ...
              description: 'Saintlammy Community Care Initiative',
              detail: 'Officially registered with Corporate Affairs Commission'
            },
            {
              icon: Eye,
            ...
            <div key={index} className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-700 hover:border-accent-500">
        ...
        {/* Donation Breakdown */}
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 md:p-12 shadow-lg border border-gray-700">
          <div className="text-center mb-8">
            <h3 className="text-2xl md:text-3xl font-semibold text-white mb-4 font-display">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-white mb-2 font-display">Direct Aid & Programs</h4>
              <p className="text-gray-300 text-sm font-light">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-white mb-2 font-display">Logistics & Volunteers</h4>
              <p className="text-gray-300 text-sm font-light">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-white mb-2 font-display">Operations</h4>
              <p className="text-gray-300 text-sm font-light">
          ...
          <div className="mt-8 p-4 bg-gray-700 rounded-xl text-center">
