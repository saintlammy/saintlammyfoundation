...
-- Run this to set up the entire volunteer and user management system
-- ===================================================================
...
CREATE TABLE IF NOT EXISTS users (
    ...
    auth_user_id uuid, -- Link to Supabase Auth (can be NULL initially)
...
UNION ALL
SELECT 'volunteer_roles', COUNT(*) FROM volunteer_roles
UNION ALL
