            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {volunteerBenefits.map((benefit, index) => (
                <div key={index} className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 border border-gray-700 hover:border-accent-500 transition-colors text-center group">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2 font-display">{benefit.title}</h3>
                  <p className="text-gray-300 text-sm font-light">{benefit.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {volunteerOpportunities.map((opportunity) => (
                <div key={opportunity.id} className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 border border-gray-700 hover:border-accent-500 transition-colors">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-white mb-1 font-display">{opportunity.title}</h3>
                  ...
                  <p className="text-gray-300 font-light leading-relaxed mb-4">{opportunity.description}</p>
                  ...
                  <button className="w-full bg-accent-500 hover:bg-accent-600 text-white py-3 px-4 rounded-full font-medium text-sm transition-colors font-sans">
                    Apply for This Role
                  </button>
                </div>
              ))}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white focus:ring-2 focus:ring-accent-500 focus:border-transparent transition-colors font-sans"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={4}
                      className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:ring-2 focus:ring-accent-500 focus:border-transparent transition-colors font-sans resize-none"
                  ...
                  <div className="flex items-start gap-3">
                    <input
                      ...
                      onChange={handleChange}
                      required
                      className="w-4 h-4 text-accent-500 bg-gray-700 border-gray-600 rounded focus:ring-accent-500 focus:ring-2 mt-1"
                    />
                    <label htmlFor="backgroundCheck" className="text-sm text-gray-300">
              ...
              {volunteerTestimonials.map((testimonial, index) => (
                <div key={index} className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 border border-gray-700 hover:border-accent-500 transition-colors">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="font-semibold text-white font-display">{testimonial.name}</h3>
                      <p className="text-sm text-accent-400 font-medium">{testimonial.role}</p>
                      <p className="text-xs text-gray-400">{testimonial.duration} volunteering</p>
                    </div>
                  </div>

                  <blockquote className="text-gray-300 font-light leading-relaxed italic">
                    "{testimonial.quote}"
                  </blockquote>
                </div>
              ))}
