  ...
  return (
    <>
      ...
      <main>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {contactInfo.map((info, index) => (
                <div key={index} className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 border border-gray-700 hover:border-accent-500 transition-colors text-center group">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2 font-display">{info.title}</h3>
                  <p className="text-accent-400 font-medium text-sm mb-2">{info.details}</p>
                  <p className="text-gray-300 text-xs font-light mb-4">{info.description}</p>
                  <a
                    href={info.link}
            ...
            <div className="space-y-6">
              {faqs.map((faq, index) => (
                <div key={index} className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 border border-gray-700">
                  <h3 className="text-lg font-semibold text-white mb-3 font-display">{faq.question}</h3>
        ...
        <section className="py-24 bg-gray-900">
          <div className="max-w-4xl mx-auto px-6">
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 md:p-12 border border-gray-700 text-center">
