          ...
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            <div className="flex gap-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-2 bg-accent-500 hover:bg-accent-600 text-white rounded-lg font-medium transition-colors whitespace-nowrap"
              >
                ...
                <tbody className="divide-y divide-gray-700">
                  {loading ? (
                    ...
                    filteredOutreaches.map((outreach: any) => (
                      <tr key={outreach.id} className="hover:bg-gray-700/50">
