      ...
      <AdminLayout title="Messages Management">
        <div className="space-y-6">
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            <h2 className="text-xl font-semibold text-white mb-4">Messages Management</h2>
            <p className="text-gray-400">Messages management interface is ready for implementation.</p>
          </div>
        </div>
      </AdminLayout>
    </>
