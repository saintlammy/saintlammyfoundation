...
const AdminWalletManagement: React.FC = () => {
  ...
  const loadWalletForNetwork = async (
    ...
    try {
      ...
      const addresses = {
        bitcoin: process.env.NEXT_PUBLIC_BTC_WALLET_ADDRESS || 'bc1q9fz4dj2chf37akk0us4qum50kam72tntx57wyz',
        ethereum: process.env.NEXT_PUBLIC_ETH_WALLET_ADDRESS || '0x284510028B1De5e9469b2392a2824dA2fa4A6063',
        bsc: process.env.NEXT_PUBLIC_BNB_WALLET_ADDRESS || '0xb51271A11F107A37523045Ee267D9232B867bd11',
        xrp: process.env.NEXT_PUBLIC_XRP_WALLET_ADDRESS || 'rsptzf9RFKHjgvuNbjMGBLtkXp37nnEo8X',
        solana: process.env.NEXT_PUBLIC_SOL_WALLET_ADDRESS || '5bKSQ9wpWmA4NxPfq3xiTv4Zpnzxjkfzm5WVwkL4Xrz3',
        tron: process.env.NEXT_PUBLIC_TRX_WALLET_ADDRESS || 'TX7UK8Q4n9GsJpnfHkQE4Mf9Z1GukgQyzk'
      };
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <select
              ...
              className="px-4 py-2 bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-accent-500"
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors"
                  >
                      ...
                      <div className="text-right">
                        ...
                        <div className="flex items-center justify-end space-x-1 mt-2">
                          ...
                          <button
                            ...
                            className="p-1 text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 transition-colors disabled:opacity-50"
            ...
            <div className="bg-gray-800 rounded-lg p-6 w-full max-w-md border border-gray-700">
              ...
              <div className="flex justify-end space-x-3 mt-6">
                <button
                  ...
                  className="px-4 py-2 bg-gray-700 text-gray-900 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
            ...
            <div className="bg-gray-800 rounded-lg p-6 w-full max-w-md border border-gray-700">
              ...
              <div className="text-center space-y-4">
                ...
                <div className="flex justify-end space-x-3">
                  <button
                    onClick={() => setShowQrModal(false)}
                    className="px-4 py-2 bg-gray-700 text-gray-900 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
                  >
                    Close
                  </button>
                  <button
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-end space-x-3 pt-4">
                  <button
                    ...
                    className="px-6 py-2 bg-gray-700 text-gray-900 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors disabled:opacity-50"
                  >
                    Cancel
                  </button>
                  <button
        ...
        {showExportModal && selectedWallet && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-gray-800 rounded-lg p-6 w-full max-w-md border border-gray-700">
              ...
              <button
                onClick={() => setShowExportModal(false)}
                className="w-full mt-4 p-2 bg-gray-700 text-gray-900 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
              >
                Cancel
              </button>
            </div>
