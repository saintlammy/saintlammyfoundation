    ...
    <>
      ...
      <div className="min-h-screen bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full text-center">
          ...
          {/* User Info */}
          {user && (
            <div className="bg-gray-800 rounded-lg p-4 mb-8 text-left border border-gray-700">
          ...
          <div className="space-y-4">
            ...
            {user && (
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 py-3 px-4 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-white rounded-lg transition-colors"
              >
